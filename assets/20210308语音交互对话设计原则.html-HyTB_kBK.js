...
function _sfc_render(_ctx, _cache) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    createBaseVNode("p", null, [
      _hoisted_12,
      createTextVNode(" 智能助手的人物设定会影响回复话术的设计，所以提前确认好智能助手的核心关键词和画像可以避免后续回复话术的修改。 "),
      _hoisted_13,
      createTextVNode(" Google的设计师通过解构那些我们习以为常的自然对话中的规则和惯例，挖掘出一个好的VUI对话的关键因素。在语音交互设计指南Actions on Google Design中提到，构建一个好的VUI对话需要考虑以下4个部分: ** 话轮转换 (Turn-taking) ** 在对话交流中，我们会在一些往返的微妙信号中轮流说话。如果没有有效的轮换，会导致对话过程中双方同时说话，或者对话内容会不同步并且难以被理解的情况。因此轮到用户说话时，智能助手应该发出清晰的信号，例如音效提醒。用户说话时智能助手不要贸然强行打断。如果是询问用户问题，那就不要在用户回答的时候又突然插入一些其他问题或者指令。 ** 对话线索 (Treading) ** 在自然交流中，对话中的上下文、对话随时间演变的方式等对话元素都会连贯地交织在一条主线上。对话中的对话线索可以帮我们更容易跟上对话流的节奏。 ** 利用语音固有的效率 ** 人们经常使用较为简短的口头表达方式，因为他们能够洞察出大家在说什么。基本上我们都可以感知出一个对话中的“言外之意”，也知道有些东西是不需要被直接说出来的。但是VUI中的隐喻必须能够弥补人类语言中看似不合逻辑、非理性的部分。 ** 预测不同的用户行为 ** 人们会用不同的词语和风格去描述同样的事情，这取决于他们自己的情景语境和自己早前经验产生的对 VUI 的预期，因此 VUI 应该支持这些差异，用户才能拥有一个无损的体验。 "),
      _hoisted_14,
      createTextVNode(" 有研究表明，人们对技术的反应就像对另一个人的反应一样。这意味着用户在和智能助手交互时，也会依赖他们现有的人与人对话方式。美国语言哲学家格莱斯（Paul Grice）认为，在人们交际过程中，对话双方似乎在有意无意地遵循着某一原则，以求有效地配合从而完成交际任务。因此，格赖斯提出了会话中的“合作原则”，语音交互可以考虑跟从对话合作原则进行设计。 ** 量的准则： ** 所说的话应该满足且不超出交际所需的信息量。 ** 质的准则： ** 不要说自知是虚假和缺乏足够证据的话。 ** 关系准则： ** 所说的话要贴切, 要与交谈目的和方向有关系, 不说不相干的话。 ** 方式准则： ** 所说的话要简洁明了,别拐弯抹角产生歧义。 然而，人们在实际言语交际中，并非总是遵守“合作原则”，有些时候人们会故意违反合作原则。格莱斯把这种通过表面上故意违反“合作原则”而产生的言外之意称为“特殊会话含义”，它是需要依赖特殊语境才能推导出来的含义。举个例子：A和B在谈论一部电影。 A：“你觉得这部电影怎么样啊？” B：“场面倒是很壮观，服装也很耀眼。”"),
      _hoisted_15,
      createTextVNode(" 表面上B并没有回答A的问题说出这部电影怎么样，但是不可否认的是，B的话语有自己的内在意义。B的回答暗指除了耀眼的服装和壮观的场面，电影本身并没有什么吸引人的地方。这内在意义需要通过语境推断出来，这样的含义就是特殊会话含义。尽管大部分的幽默源于特殊会话含义，但我们在设计脚本过程中，尽量避免使用这种对话方式，避免用户一时半刻理解不了这句话的意思。 ** 8.对话不存在“出错”的概念 ** 逻辑和准确性不是万能法则，人类口语表达通常会呈现出各种毫无道理的话。用户任何请求都是有目的的，他们总是希望完成某些任务，即使没有明确说出来。这时候，不要管用户说了什么，不要把它当成是一个错误来处理，而是考虑如何把它转变为一个机会，把它当做是对话中的转折点，用新的方式来处理，从而推进更顺畅、更自然的沟通。以下方法有助于把“错误”转化为对话交互中自然的一部分： （1）不要把技术上的“出错”当做用户的错误。 （2）对于不同类型的“出错”提供对应适合的处理方式。 （3）通过提供帮助来避免出错。 （4）要知道在什么情况下放弃。 （5）使完成任务的路径更强，来掩盖错误。"),
      _hoisted_16,
      createTextVNode(" ** 文章最后 ** 最近笔者会抽空把第二本书中和语音交互设计相关的内容陆续更新到公众号，后续还有三部分内容，分别是《任务型对话原则》、《恢复对话设计原则》以及《语音交互的GUI设计》。如果读者对本节内容有任何建议或者疑问，请在后台留言:-)"),
      _hoisted_17,
